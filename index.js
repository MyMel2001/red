...
const MarkdownIt = require('markdown-it'); // <-- ADDED
const markdownItSanitizeHtml = require('@mshibanami-org/markdown-it-sanitize-html'); // <-- ADDED
...
md.use(markdownItSanitizeHtml, {
    ...
    // It defaults to a list of common, safe tags, but we ensure it only allows 
    // basic formatting generated by the markdown, and explicitly strips <script>
